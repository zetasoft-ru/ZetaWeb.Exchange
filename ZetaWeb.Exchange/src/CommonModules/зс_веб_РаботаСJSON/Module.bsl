...
// Методы:
//	ПрочитатьJSONПрограммно – парсер;
//	ЗаписатьJSONПрограммно – сериализатор.
...
//
Функция ПрочитатьJSONПрограммно(Значение, Стандарт = Истина, ПредставленияСсылок = Ложь, АвтоматическиПриводитьОбъектыКСтруктуре = Ложь) Экспорт 
	
	Возврат jsonПрочитатьИнициализация(Значение, Стандарт, ПредставленияСсылок, АвтоматическиПриводитьОбъектыКСтруктуре);
	
КонецФункции // ПрочитатьJSONПрограммно()
...
//
Функция ЗаписатьJSONПрограммно(Значение, Стандарт = Истина, ПредставленияСсылок = Ложь, 
...
КонецФункции // ЗаписатьJSONПрограммно()
